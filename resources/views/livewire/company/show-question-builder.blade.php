<div class="card-body pl-0 pr-0">
    @section('buttonCustom')
        <div class="dropdown">
            <button class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">افزودن سوال</button>
                        ...
                        @if($activeQuestion)
                            <div class="col-lg-8">
                                <div class="question-tab">
                                    ...
                                    @if(in_array($activeQuestion->type, ['multiple-choices', 'dropdown', 'yes-no']))
                                        ...
                                        @if(in_array($activeQuestion->type, ['multiple-choices', 'dropdown']))
                                            <div class="col-md-12 text-left mx-auto pl-0 mb-30">
                                                <button class="btn btn-info btn-sm" wire:click.prevent="addChoice({{ $activeQuestion->id }})"><i class="fas fa-plus mr-2"></i>{{ __('انتخاب کنید') }}</button>
                                            </div>
                                        @endif
                                    @endif
                                    @if(in_array($activeQuestion->type, [ 'slider']))
                                    <label for="visibility">{{ __('مقدار حداقل و حداکثر دامنه خود را برای نوار لغزنده وارد کنید') }}</label>
                                        @foreach($choices as $key => $choice)
                                            <div class="next-choice">
                                                <div class="col-md-12 col-12 px-0 d-flex">
                                                    <div class="col-md-10 px-0">
                                    ...
                                    <button type="submit" class="btn btn-primary w-100 mb-3 mt-10"><i class="far fa-save mr-2"></i>{{ __('ذخیره') }}</button>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="question-tab question-right">
                                    ...
                                    <div class="form-group col-md-12 px-0">
                                        <label for="position">{{ __('موقعیت') }}</label>
