    ...
    <div class="content-wrapper">
        ...
        <section class="content text-right">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('مجموع کاربران') }}</span>
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('مجموع نظر ها') }}</span>
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('مجموع پاسخ ها') }}</span>
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('تعداد نظرسنجی ها در روز') }}</h3>
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('تعداد پاسخ ها در روز') }}</h3>
