                ...
                <div class="col-12">
                    <div class="card card-outline card-success mt-3">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('ویرایش درخواست پرداخت آفلاین') }}</h3>
                        </div>
                        <form role="form" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label text-sm-right">{{ __('میزان') }}</label>
                                    <div class="col-sm-4">
                                        <input type="text"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label text-sm-right">{{ __('وضعیت') }}</label>
                                    <div class="col-sm-4">
                                        <input type="text"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label text-sm-right">{{ __('یادداشت') }}</label>
                                    <div class="col-sm-4">
                                        <input type="text"
