                ...
                <div class="col-12">
                    <div class="card card-outline card-success mt-3">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('افزودن طرح') }}</h3>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control @error('interval') is-invalid @enderror" name="interval" value="{{ old('interval') }}">
                                            ...
                                            <option value="monthly" @if (old('interval')=="monthly" ) {{ 'selected' }} @endif>{{ __('ماهانه') }}</option>
                                            <option value="yearly" @if (old('interval')=="yearly" ) {{ 'selected' }} @endif>{{ __('سالانه') }}</option>
                                        </select>
                                        @error('interval')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text"
                                            ...
                                            name="survey_count" value="{{ old('survey_count') }}" placeholder="تعداد">
                                        @error('survey_count')
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text"
                                            ...
                                            name="question_count_per_survey" value="{{ old('question_count_per_survey') }}" placeholder="تعداد">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text"
                                            ...
                                            name="response_count_per_survey" value="{{ old('response_count_per_survey') }}" placeholder="تعداد">
