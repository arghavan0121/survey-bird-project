    ...
    <div class="col-12">
        <div class="card card-outline card-success mt-3">
            <div class="card-header">
                <h3 class="card-title">{{ __('کد خرید') }} @if($envatoPurchaseCode) (افزودن) @else (نیفزودن) @endif</h3>
            </div>
            <form role="form" method="POST" action="{{ route('admin.extensions.updateLicense') }}">
                {{ csrf_field() }}
                <div class="card-body">
                    <p><a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">کد خرید من کجاست؟</a></p>

                    <div class="form-group row">
                        <label for="envato_purchase_code" class="col-sm-3 col-form-label text-sm-right">{{ __('کد خرید') }}</label>
                        <div class="col-sm-5">
